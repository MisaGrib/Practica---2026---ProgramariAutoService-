...
export default function Login() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'Segoe UI, sans-serif' }}>
      ...
      <div style={{
        ...
        display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', paddingTop: '20px', paddingLeft: '30px'
      }}>
  ...
  <span style={{ fontWeight: 800, fontSize: 20 }}>
    <span style={{ color: '#fff' }}>Autopro</span><span style={{ color: '#2563eb' }}>Moldova</span>
  </span>
</div>
       <h1 style={{ color: '#fff', fontSize: 42, fontWeight: 900, lineHeight: 1.2, marginBottom: 16, marginTop: '35vh' }}>
  ...
  Accesează contul tău pentru a vedea programările, stadiul reparațiilor și istoricul auto.
      ...
      {/* Buton inapoi acasa */}
       <button onClick={() => navigate('/')} style={{
          ...
          fontSize: 14, textAlign: 'left', display: 'flex', alignItems: 'center', position: 'absolute', margin: '20px 0 0 1373px', gap: 6,
          fontWeight: 600
        }}>
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: 30, fontWeight: 900, marginBottom: 10, marginLeft: 70 }}>Autentificare</h2>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
          ...
          <span onClick={() => navigate('/forgot-password')} style={{ fontSize: 12, color: '#2563eb', cursor: 'pointer', fontWeight: 600 }}>AM UITAT PAROLA</span>
        </div>
        <div style={{
  display: 'flex', alignItems: 'center', gap: 10, border: '1px solid #e5e7eb',
